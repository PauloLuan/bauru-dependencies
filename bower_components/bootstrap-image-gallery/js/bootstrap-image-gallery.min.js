    ...
    function (a, b)
    {
        ...
        a.extend(
            ...
            {modalFactory: function (a, b, c, d)
            {
                ...
                var e = this, f = this.container.children(".modal"), g = f.clone().show().on(
                    "click",
                    function (a) {(a.target === g[0] || a.target === g.children()[0]) && (a.preventDefault(), a.stopPropagation(), e.close())}
                ), h = d.call(this, a, function (a) {b({type: a.type, target: g[0]}), g.addClass("in")}, c);
            ...
            }, close: function () {this.container.find(".modal").removeClass("in"), c.call(this)}}
        )
    }
);